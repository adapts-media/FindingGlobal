...
import { calculateMatchScore, MATCH_THRESHOLD } from "../server/src/lib/matching.js";
...
async function run() {
  ...
  try {
    ...
    // Let's mock the project details from the screenshot:
    ...
    // Let's run the DB query used in projects.js:
    const query = {
      verified: true,
      $or: [
